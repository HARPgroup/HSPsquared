...
from hsp2.om.om import is_float_digit
from hsp2.state.state import set_state, get_state_ix
from hsp2.om.om_model_object import ModelObject, ModelConstant
...
class Equation(ModelObject):
    ...
    def __init__(self, name, container=False, model_props={}, state=None):
        ...
        self.min_value_ix = ModelConstant(
            "min_value", self, {"name": "min_value", "value": min_value}
        ).ix
