...
from hsp2.hsp2.state.state_fn import rqual_init_ix, rqual_state_vars
...
ERRMSGS_nutrx = (
    "NUTRX: Error -- Inconsistent flags for NH4; TAM is not being simulated, but NH3 volatilization and/or NH4 adsorption are being simulated.",
...
ERRMSGS_plank = (
    "PLANK: Error -- Zooplankton cannot be simulated without phytoplankton.",
...
ERRMSGS_phcarb = (
    "PHCARB: Error -- Invalid CONS index specified for ALKCON (i.e., ALKCON > NCONS).",
...
def rqual(
    ...
    (errors, ERRMSGS) = _compile_errors(
        NUTFG, PLKFG, PHFG, err_oxrx, err_nutrx, err_plank, err_phcarb
    )
