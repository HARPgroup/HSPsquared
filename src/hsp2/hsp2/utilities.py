...
def save_timeseries(
    ...
    if (operation == "IMPLND" and activity == "IQUAL") or (
        operation == "PERLND" and activity == "PQUAL"
    ):
...
def get_gener_timeseries(
    ts: Dict, gener_instances: Dict, ddlinks: List, ddmasslinks
) -> Dict:
    """
