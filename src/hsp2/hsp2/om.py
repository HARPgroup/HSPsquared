...
from hsp2.hsp2.state import append_state, get_ix_path, get_state_ix
...
def init_op_tokens(state_ix, op_tokens, tops, eq_ix):
    """
...
def time_perf(siminfo, model_exec_list, op_tokens, state_ix, dict_ix, ts_ix, steps):
    start = time.time()
